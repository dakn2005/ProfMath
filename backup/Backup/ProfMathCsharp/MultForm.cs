...
{
	/// <summary>
	/// Description of MultForm.
	/// </summary>
	public partial class MultForm : UserControl
	{
		...
		void MultFormLoad(object sender, EventArgs e)
		{
		...
		{
			pm.moveToNext(3,label3,counter,lblcounter,failtimes,picface,txtans,rad);
        	counter=pm.profMultcounter;
        	failtimes=pm.profMultfails;
		}
